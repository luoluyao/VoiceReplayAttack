...
def main():
    ...
    filename_origin = '/home/lly/caoch/protocol/ASVspoof2017_train.trn_machine.txt'
    dir = "/home/lly/caoch/ASVspoof2017_train/ASVspoof2017_machine/"
    ...
    for i in range(10):
        ...
        for file in filenames:
            cmd = "python getMfcc_ASVsproof.py " + dir + file + " >> " + dir + result_filename + str(i)
            cmds.append(cmd)
            count += 1
            if count % 10 == 0:
                thread_cmd(cmds)
